                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" class="form-control" name="product_content" id="exampleInputPassword1" 
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control input-sm m-bot15" name="product_cate">
                                @foreach ($cate_product as $key => $cate)
                                    ...
                                    <option selected value="{{$cate->category_id}}">{{$cate->category_name}}</option></option>
                                    @else
