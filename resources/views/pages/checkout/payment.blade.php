    ...
    <div class="container">
        ...
        <form action="{{URL::to('/order-place')}}" method="POST">
            ...
            <div class="payment-options">
                ...
                <span>
                    <label><input name="payment_option" value="2" type="checkbox"> Thanh toán bằng Paypal</label>
                </span>
                <span>
                    <label><input name="payment_option" value="3" type="checkbox"> Nhận hàng xong thanh toán</label>
                </span>
